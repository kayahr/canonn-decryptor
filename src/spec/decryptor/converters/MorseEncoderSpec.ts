import { MorseEncoder } from "../../../main/decryptor/converters/MorseEncoder";
...
describe("MorseEncoder", () => {
    ...
    describe("toJSON", () => {
        it("serializes the converter", () => {
            expect(new MorseEncoder("*", "#").toJSON()).toEqual({
                "type": "morse-encoder",
                "options": {
                    "dot": "*",
                    "dash": "#"
    ...
    describe("fromJSON", () => {
        it("deserializes a converter", () => {
            ...
            expect(converter).toEqual(jasmine.any(MorseEncoder));
            expect(converter.getDot()).toBe("*");
            expect(converter.getDash()).toBe("#");
        });
